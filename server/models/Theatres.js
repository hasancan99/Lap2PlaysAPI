...
class Theatre {
  ...
  static async createTheatre(theatre) {
    ...
    const query =
      "INSERT INTO theatres (theatre_name, theatre_location, phone_number, capacity) VALUES ($1, $2, $3, $4) RETURNING *";
  ...
  static async updateTheatre(id, theatre) {
    const { theatre_name, theatre_location, phone_number, capacity } = theatre;
    const query =
      "UPDATE theatres SET theatre_name = $1, theatre_location = $2, phone_number= $3, capacity= $4  WHERE theatre_id =$5 RETURNING *";
